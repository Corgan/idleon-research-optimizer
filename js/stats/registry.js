...
import spelunkingMaxStamina from './defs/spelunking-max-stamina.js';
import amberSupplySwap from './defs/amber-supply-swap.js';
...
registerDescriptor(spelunkingMaxStamina);
registerDescriptor(amberSupplySwap);
