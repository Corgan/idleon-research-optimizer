...
//   if idx in [4,9,14,19]: max(1, getbonus2(1,207,-1, saveData)) * (1 + ExoticBonusQTY(14)/100) * NinjaInfo[36][idx] * FarmRank[2][idx]
//   else: max(1, getbonus2(1,207,-1, saveData)) * (1 + ExoticBonusQTY(14)/100) * 1.7 * NinjaInfo[36][idx] * FarmRank[2][idx] / (FarmRank[2][idx] + 80)
...
export function farmRankUpgBonus(idx, activeCharIdx, saveData) {
  ...
  var exotic14 = 0;
  try { exotic14 = computeExoticBonus(14, saveData) || 0; } catch(e) {}
