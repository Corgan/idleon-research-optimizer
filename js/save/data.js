...
export let currentMapDataAvailable = [];
export let afkTargetData = [];
export let attackLoadoutData = [];
export let attackLoadoutDataAvailable = [];
export let combatAfkInputDataAvailable = [];
export let maxCarryCapData = [];
...
export function assignSaveData(u) {
  ...
  if ('currentMapDataAvailable' in u) currentMapDataAvailable = u.currentMapDataAvailable;
  if ('afkTargetData' in u) afkTargetData = u.afkTargetData;
  if ('attackLoadoutData' in u) attackLoadoutData = u.attackLoadoutData;
  if ('attackLoadoutDataAvailable' in u) attackLoadoutDataAvailable = u.attackLoadoutDataAvailable;
  if ('combatAfkInputDataAvailable' in u) combatAfkInputDataAvailable = u.combatAfkInputDataAvailable;
  if ('maxCarryCapData' in u) maxCarryCapData = u.maxCarryCapData;
