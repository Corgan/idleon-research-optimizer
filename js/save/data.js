...
export let inventoryOrderData = [];
export let foodSlotsOwnedData = [];
...
export function assignSaveData(u) {
  ...
  if ('inventoryOrderData' in u) inventoryOrderData = u.inventoryOrderData;
  if ('foodSlotsOwnedData' in u) foodSlotsOwnedData = u.foodSlotsOwnedData;
